...
render:set(MOAIParticleScript.SPRITE_RED, CONST(0.9607843137254902))
render:set(MOAIParticleScript.SPRITE_GREEN, CONST(0.7058823529411765))
render:set(MOAIParticleScript.SPRITE_BLUE, CONST(0.21176470588235294))
